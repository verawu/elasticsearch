...
public class DeferredHnswVectorsFormatTests extends BaseKnnVectorsFormatTestCase {
    ...
    private static VectorBuildExecutorService buildService;

    @Override
    public void setUp() throws Exception {
        threadPool = new TestThreadPool("deferred-hnsw-test", Settings.EMPTY);
        buildService = new VectorBuildExecutorService(threadPool, 4);
        super.setUp();
    }
    ...
    protected Codec getCodec() {
        return new Lucene912Codec() {
            ...
            public KnnVectorsFormat getKnnVectorsFormatForField(String field) {
                return new ESHnswVectorsFormat(16, 100, buildService);
            }
        };
    }
