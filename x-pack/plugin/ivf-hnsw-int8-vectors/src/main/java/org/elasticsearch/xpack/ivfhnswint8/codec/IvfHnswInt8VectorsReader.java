...
import static org.elasticsearch.xpack.ivfhnswint8.codec.IvfHnswInt8VectorsFormat.DATA_CODEC_NAME;
import static org.elasticsearch.xpack.ivfhnswint8.codec.IvfHnswInt8VectorsFormat.DATA_EXTENSION;
import static org.elasticsearch.xpack.ivfhnswint8.codec.IvfHnswInt8VectorsFormat.META_CODEC_NAME;
import static org.elasticsearch.xpack.ivfhnswint8.codec.IvfHnswInt8VectorsFormat.META_EXTENSION;
import static org.elasticsearch.xpack.ivfhnswint8.codec.IvfHnswInt8VectorsFormat.VERSION_CURRENT;
import static org.elasticsearch.xpack.ivfhnswint8.codec.IvfHnswInt8VectorsFormat.VERSION_START;

public class IvfHnswInt8VectorsReader extends KnnVectorsReader {
    ...
    public IvfHnswInt8VectorsReader(SegmentReadState state, int nprobe, boolean rerank) throws IOException {
        this.nprobe = nprobe;
        this.rerank = rerank;
    ...
    public FloatVectorValues getFloatVectorValues(String field) throws IOException {
        ...
        return new IvfHnswInt8FloatVectorValues(entry, data.clone());
    }
    ...
    static class IvfHnswInt8FloatVectorValues extends FloatVectorValues {
        ...
        IvfHnswInt8FloatVectorValues(FieldEntry entry, IndexInput dataInput) {
            this.entry = entry;
        ...
        public VectorScorer scorer(float[] target) throws IOException {
            IvfHnswInt8FloatVectorValues copy = new IvfHnswInt8FloatVectorValues(entry, dataInput.clone());
            return new VectorScorer() {
                @Override
                public float score() throws IOException {
                    float[] vec = copy.vectorValue();
                    return IvfHnswInt8VectorsReader.score(target, vec, entry.similarity);
                }
